...
.validateTips {
	...
	$.post("call_single_object_by_sku.php", { object_sku: object_sku.val() })
.done(function(data) {
...
<div id="dialog-form" title="Parameters Dialog Box">
      <p class="validateTips">Please provide id: e.g. <b>C771</b></p>
      <form>
    <fieldset>
          <label for="object_sku">Element SKU</label>
          <input type="text" name="object_sku" id="object_sku" class="text ui-widget-content ui-corner-all" />
        </fieldset>
  </form>
    </div>
