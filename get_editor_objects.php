...
.validateTips {
	...
	$.post("call_get_editor_objects.php", { brand: brand.val() })
.done(function(data) {
...
<div id="dialog-form" title="Parameters Dialog Box">
      <p class="validateTips">Please provide brandname:<b>Apple_iPad</b></p>
      <form>
    <fieldset>
...
try {
    ...
    $response = SureDone_Store::editor_objects('items', 2, "date_", isset($_SESSION['username'])?$_SESSION['username']:'');
