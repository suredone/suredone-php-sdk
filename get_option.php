...
.validateTips {
	...
	$.post("call_get_option.php", { option_name: option_name.val() })
.done(function(data) {
...
<div id="dialog-form" title="Parameters Dialog Box">
      <p class="validateTips">Please provide option: e.g. <b>site_domain</b></p>
      <form>
    <fieldset>
          <label for="option_name">Option Name</label>
          <input type="text" name="option_name" id="option_name" class="text ui-widget-content ui-corner-all" />
        </fieldset>
  </form>
    </div>
