...
.validateTips {
	...
	$.post("call_get_packing_orders.php", { page_no: page_no.val() })
.done(function(data) {
...
echo "---- Testing Get Packing Orders ----<br>";


$params = array();
$response = SureDone_Store::get_packing_orders($_REQUEST['page_no'], 'scountry', $token, isset($_SESSION['username'])?$_SESSION['username']:'');
